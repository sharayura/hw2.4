public class Main {
    public static void main(String[] args) {
        ...
        honda.setRegNumber("а230пр000");
        honda.setSeasonRubber();
        System.out.println(honda.getRegNumber());
        System.out.println(honda.getSeasonRubber());
        honda.getInsurance().setInsTerm(2020, 10, 23);
        honda.getInsurance().checkInsTerm();
