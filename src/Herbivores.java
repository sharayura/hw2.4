public class Herbivores extends Mammals {
    ...
    public Herbivores(String form, String name, int age, String area, int speed, String food) {
        super(name, age, area, speed);
        this.form = (form != null && !form.isEmpty() && !form.isBlank()) ? form : "травоядное животное";
        setFood(food);
    }
